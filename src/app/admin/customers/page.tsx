...
export default async function CustomersPage() {
  ...
  return (
    <div>
      <h1 className="mb-1 text-2xl font-bold text-neutral-800">ลูกค้า / ค้างชำระ</h1>
      <p className="mb-6 text-neutral-500">ทะเบียนลูกค้า และยอดค้างชำระจากใบวางบิล</p>

      {/* ค้างชำระ */}
      <section className="mb-8">
        <div className="mb-3 flex items-center justify-between">
          <h2 className="text-lg font-bold text-neutral-800">ยอดค้างชำระ</h2>
          <span className="rounded-lg bg-red-50 px-3 py-1 font-bold text-red-700">
            ...
            {owed.map((d) => (
              ...
              >
                <div className="min-w-0 flex-1">
                  ...
                  <div className="truncate text-neutral-500">{d.customerName || 'ไม่ระบุลูกค้า'}</div>
                </div>
                <div className="text-right">
                  <div className="font-bold text-red-600">ค้าง ฿{formatBaht(d.remain)}</div>
      ...
      <h2 className="mb-3 text-lg font-bold text-neutral-800">ทะเบียนลูกค้า</h2>
      <CollectionManager
